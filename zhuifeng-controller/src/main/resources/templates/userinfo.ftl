...
<section class="Contain">
    <div class="Current">当前位置:<a href="index.html">首页</a> <em>|</em> <a href="#" class="column">会员中心</a> <span>个人信息</span></div>
    ...
    <div class="Content">
        <div class="columnname">个人信息</div>
        <div class="content">
            <div class="membertable table1">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="left"><span class="true">*</span>用户名称：</td>
                        <td><input type="text" class="text" value="${(userpojo.uname)!''}"></td>
                    </tr>
                    <tr>
                        <td class="left"><span class="true">*</span>手机号：</td>
                        <td><input type="text" class="text" value="${(userpojo.uphone)!''}"></td>
                    </tr>
                    <#--<tr>
                        <td class="left">偏好设置：</td>
                        <td>
                            <select>
                                <option><b>航线</b></option>
                                <option>航线 </option>
                                <option>第三级</option>
                            </select>
                            <select>
                                <option><b>服务</b> </option>
                                <option>HDS </option>
                                <option>托外场</option>
                            </select>
                            <select>
                                <option><b>货类</b></option>
                                <option>货类代码 </option>
                            </select>
                        </td>
                    </tr>-->
                    <tr>
                        ...
                        <td><input type="text" class="text" value="${(userpojo.uemail)!''}"></td>
                    </tr>
                    <tr>
                        <td class="left">微信：</td>
                    ...
                    <tr>
                        <td class="left"></td>
                        <td><input type="button" class="btn" value="更 新"> <input type="button" class="btn btn2" value="取 消"></td>
                    </tr>
                    <tr>
                        <td class="left"></td>
                        <td><a href="" class="edit">[编辑修改]</a><span class="true">*</span><span class="must">号内容为必填</span></td>
                    </tr>
                </table>
            </div>
        </div>
