        ...
        <div class="content">
            ...
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td><input type="text" class="text"><span class="num">请输入1-20个字符</span></td>
                </tr>
                 <tr>
                    <td class="left"><span class="true">*</span>用户密码：</td>
                    <td><input type="text" class="text"><span class="num">请输入6-16个字符</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="left"><span class="true">*</span>接收信息方式：</td>
                    <td><input type="checkbox" class=""><em class="check">电子邮件</em><input type="checkbox" class=""><em class="check"> 短信</em></td>
                </tr>	
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" class="text"><span class="num">例：200000</span></td>
                </tr>
                 <tr>
                    <td class="left"><span class="true"></span>固定电话：</td>
                    <td><input type="text" class="text"><span class="num">例：02112345678(上海电话)</span></td>
                </tr>
                <tr>
                    <td class="left"><span class="true"></span>手机：</td>
                    <td><input type="text" class="text"><span class="num">例：13800000000</span></td>
                </tr>
                 <tr>
                    <td class="left"><span class="true">*</span>请输入验证码：</td>
                    <td><input type="text" class="text text2"><span class="code"><img src="uploadfiles/image/code.jpg"></span><span class="num">看不清?点击图片即可重新生成(请区分大小写)</span></td>
                </tr>	
                <tr>
                    <td class="left"></td>
                ...
                <tr>
                    <td class="left"></td>
                    <td><input type="submit" class="btn" value="提 交"><input type="button" class="btn btn2" value="取 消"></td>
                </tr>
                <tr>
                    <td class="left"></td>
